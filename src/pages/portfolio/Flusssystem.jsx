                    ...
                    <div className="row">
                        ...
                        <div className="col-xl-4 col-lg-5 p-0">
                            <div
                                ...
                                <h4 className="alt-font text-extra-light-gray font-weight-600 mb-0">Die
                                    Visualisierung des Flusssystems</h4>
                                <div className="bg-deep-green separator-line-horrizontal-full d-inline-block margin-25px-tb"></div>
                                <p className="text-medium-gray w-90 w-100 margin-35px-bottom text-medium line-height-28">Filtern
                        ...
                        <div className="col-lg-10">
                            ...
                            <p className="text-medium text-dark-gray line-height-28 sm-line-height-26">
                                Nachdem ich <a href="https://www.qgistutorials.com/en/docs/3/river_styling_expressions.html"
                                    target="_blank"><strong className="text-decoration-underline">diesen Beitrag</strong></a> auf LinkedIn angesehen hatte, fühlte ich mich inspiriert, diesen Weg zu wiederholen, jedoch
